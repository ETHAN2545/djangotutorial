...
class PollsURLTests(SimpleTestCase):
    ...
    def test_results_url(self):
        self.assertURLEqual(reverse("polls:results", args=[1]), "/polls/1/results/")
...
class PollsLiveServerTests(LiveServerTestCase):
    def test_index_page_served_on_live_server(self):
        ...
        self.assertIn(b"Live server question?", response.read())
